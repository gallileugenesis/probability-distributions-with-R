...
prob_duas_vendas <- dbinom (x = 2, size = 10, prob = 0.5)
prob_duas_vendas
...
# Podemos utilizar a mesma função para nos dar a probabilidade do sucesso o
# correr na primeira tentativa,
...
#########################################
# Exemplo: Definindo como sucesso o cliente comprar, e supondo que a 
# probabilidade de sucesso é 50%. Qual a probabilidade de ter que entrar 8 
# clientes até que a segunda venda ocorra?
...
# probabilidade de que 5(x) clientes
# entrem em um minuto?
...
# use acontece porque o paramentro
...
# empresa sigam uma distribuição normal com média μ=2.500 e desvio padrão σ= 170.
# Ao selecionar aleatoriamente um indivíduo dessa população, qual a 
# probabilidade de ter salário entre #2.400 e 2.600 ?
# Precisamos achar a probabilidade do indivíduo ter um salário de até 2.600 e 
# subtrair pela probabilidade do indivíduo ter o salário até 2.400
...
#########################################
# O comando scale() padroniza uma variável aleatória. Ao aplicar o comando na 
# variável va_normal que acabmos de criar, ela ficará com média zero e desvio 
# padrão unitário
...
# empresa sigam uma distribuição #normal com média μ=2.500 e desvio padrão σ= 170.
# Ao selecionar aleatoriamente um indivíduo dessa população, qual a 
# probabilidade de ter salário acima de 2.600 ?
